...
einzige_eingabedatei: ../../inhalt/buchdaten.typ
stand: 2026-08-26
---
...
Alle Angaben stehen in **`inhalt/buchdaten.typ`** (im Wurzelordner): Titel, Verfasser, Bandnummer,
...
> die endgültige Seitenzahl eine andere Bundstärke, diese in `inhalt/buchdaten.typ`
